...
public class NimbusJwtEncoder {
	...
	public String encode(Jwt jwt) throws JwtException {
		try {
			JWSHeader header = new JWSHeader(jwsAlgorithm, JOSEObjectType.JWT, null, null, null, null, null, null, null,
				null, null, null, null);
			...
			if (jwt.getNotBefore() != null)
				claimsBuilder.notBeforeTime(Date.from(jwt.getNotBefore()));
			if (jwt.getIssuer() != null)
				claimsBuilder.issuer(jwt.getIssuer().toString());
